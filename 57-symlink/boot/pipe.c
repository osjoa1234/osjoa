...
#define PIPE_MODE (0010000U | 0600U)

static u32 pipe_mode(int bfd) { (void)bfd; return PIPE_MODE; }

static vfs_ops_t pipe_read_ops  = { 0, pipe_read, 0, 0, pipe_read_close,  pipe_read_dup, 0, pipe_mode };
static vfs_ops_t pipe_write_ops = { 0, 0, pipe_write, 0, pipe_write_close, pipe_write_dup, 0, pipe_mode };
