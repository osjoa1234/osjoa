...
static vfs_ops_t ext2_ops   = { ext2_open, ext2_read, ext2_write, ext2_size, ext2_close, 0, ext2_getdents, ext2_mode, ext2_mkdir, ext2_unlink, ext2_symlink, ext2_readlink, ext2_lstat };
