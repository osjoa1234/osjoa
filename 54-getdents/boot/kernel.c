...
static vfs_ops_t initrd_ops = { initrd_open, initrd_read, 0, initrd_size, initrd_vfs_close, 0, 0, initrd_mode };
static vfs_ops_t ext2_ops   = { ext2_open, ext2_read, 0, ext2_size, ext2_close, 0, ext2_getdents, ext2_mode };
