...
void init_main(unsigned long *stack)
{
    ...
    {
        static char argv0[] = "syscall64";
        static char argv1[] = "envtest";
        char *st_argv[3];
        ...
        writes("shell: syscall64 envtest:\n");
        run_argv(st_argv);
    }
    ...
    {
        static char argv0[] = "touch";
        static char argv1[] = "/disk/touched.txt";
        char *touch_argv[3];
        ...
        writes("shell: touch /disk/touched.txt:\n");
        run_argv(touch_argv);
    }
...

    {
        ...
        static char argv1[] = "/disk/hello.txt";
        char *cat_argv[3];
        ...
        writes("shell: cat /disk/hello.txt:\n");
        run_argv(cat_argv);
    }
    ...
    {
        static char argv0[] = "mkdir";
        static char argv1[] = "/disk/bbdir";
        char *mkdir_argv[3];
        ...
        writes("shell: mkdir /disk/bbdir:\n");
        run_argv(mkdir_argv);
    }
    check_getdents("/disk/", "bbdir");

    {
        static char argv0[] = "rm";
        static char argv1[] = "/disk/touched.txt";
        char *rm_argv[3];
        ...
        writes("shell: rm /disk/touched.txt:\n");
        run_argv(rm_argv);
    }
    check_getdents_absent("/disk/", "touched.txt");

    {
        static char argv0[] = "ls";
        static char argv1[] = "/disk";
        char *ls_argv[3];
...

    {
        ...
        writes("shell: sh -c 'cat /disk/hello.txt':\n");
        run_argv(sh_argv);
    }

    {
        static char argv0[] = "echo";
        static char argv1[] = "aaaaaaaaaa";
        char *echo_argv[3];
    ...
    {
        static char line[] = "cat < /disk/hello.txt";
...

    {
        ...
        writes("shell: cat < /disk/hello.txt | cat:\n");
        run_line(line);
    }

    {
        static char line[] = "cat < /disk/does_not_exist.txt";

        writes("shell: cat < /disk/does_not_exist.txt (missing file check):\n");
        run_line(line);
    }
